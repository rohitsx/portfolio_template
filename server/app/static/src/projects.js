	...
	const projectsData = () => [
		{
			...
			description: "StreamSync integrates voice with super chats for a more interactive streaming experience.",
		...
		},
		{
			...
			description: "Real-time video chat app inspired by Omegle. It allows users to connect with strangers for live video calls and text chats.",
			html_url: "https://github.com/rohitsx/omegleClone",
			techStack: ["react", "nodejs", "socket.io", "webrtc"],
		},
		{
			full_name: "ai-movie-chatbot",
			description: "REST API chatbot allows users to interact with movie characters, retrieve movie scripts, and perform semantic searches using AI techniques.",
