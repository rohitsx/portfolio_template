...
>
  ...
  <div className="h-full px-4">
    <iframe className="w-full h-full" src="https://docs.google.com/document/d/e/2PACX-1vSJUigr1CQpYj5VoJ330Nafz5blrPrCM5taCypzjtU_CA7x-efdEfJAQQUhFL1G4dRIQbit5ocVnamT/pub?embedded=true"></iframe>
  </div>
  </div>
}
